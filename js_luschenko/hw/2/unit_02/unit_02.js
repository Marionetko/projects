...
function t12() {
    ...
    let inputName = document.querySelector('.i-12_1').value;
    let inputSurname = document.querySelector('.i-12_2').value;
    let out = document.querySelector('.out-12');

    out.innerHTML = 'Hello ' + inputName + ' ' + inputSurname;
}
...
function t19() {
    ...
    out.innerHTML = parseInt(num1 + num2);
...
function t20() {
    ...
    out.innerHTML = 'Уважаемый ' + name + ' ' + surname + ', ваш возраст ' + age + ' года, по професси вы ' + profession;
