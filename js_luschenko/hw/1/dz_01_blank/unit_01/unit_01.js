...
document.querySelector('.three').innerHTML = '<h3>lorem lorem lorem lorem</h3>';
...
document.querySelector('.four').innerHTML = '<h4>lorem lorem lorem</h4>';
document.querySelector('.four').innerHTML += '<p>ipsum ipsum ipsum</p>';
